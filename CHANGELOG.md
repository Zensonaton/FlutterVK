...
Данное обновление привносит в себя важное изменение: переход от rendering engine "Skia" к "Impeller" на OS Android. **ЕСЛИ У ВАС СЛОМАЕТСЯ ПРИЛОЖЕНИЕ НА ЭТОЙ ВЕРСИИ**, то откатитесь, [загрузив предыдущую версию, `v0.4.18`](https://github.com/Zensonaton/FlutterVK/releases/tag/0.4.18).
