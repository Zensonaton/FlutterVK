...
Экспериментальный неофициальный клиент ВКонтакте с открытым исходным кодом,<br>
построенный при помощи фреймворка [Flutter](https://flutter.dev/),<br>
с поддержкой прослушивания музыки без необходимости приобретать подписку VK BOOM.
