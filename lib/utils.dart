...
/// Возвращает цветовую схему приложения из передаваемого [ColorScheme].
ThemeData getTheme(ColorScheme scheme, Brightness brightness, bool isOLED) {
  // Если включена OLED-тема, то меняем цвета.
  if (isOLED) {
